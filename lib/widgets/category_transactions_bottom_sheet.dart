...
class _CategoryTransactionsBottomSheetState extends State<CategoryTransactionsBottomSheet> {
  ...
  Future<void> _refreshTransactions() async {
    ...
    try {
      // Reload all transactions and filter by category
  ...
  Future<void> _editTransaction(Transaction transaction) async {
    ...
    if (selectedCategory != null && selectedCategory.name != transaction.category) {
      ...
      try {
        ...
        // Refresh the list after a small delay to ensure database write completes
  ...
  Widget build(BuildContext context) {
    ...
    // Find category from loaded categories, fallback to create temp category
    Category category;
    try {
      category = _allCategories.firstWhere((c) => c.name == widget.categoryName);
    } catch (e) {
      // Create temporary category if not found
      final oldCategory = Categories.getByName(widget.categoryName);
      category = Category(
            ...
            child: SafeArea(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pop(context, true); // Signal to navigate to Transactions
                  },
